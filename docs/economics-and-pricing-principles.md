...
Текущая инфраструктура пилота стоит около 12 000 ₽/мес:
...
Грубая оценка для отказоустойчивого пилота: 30 000 ₽+/мес при расширении Kubernetes до нескольких нод. Это всё ещё "минимально живое" железо, не доказанная ёмкость под реальные нагрузки.
...
```text
12 000 ₽ / 2 tenants = 6 000 ₽ raw infra / tenant / month
30 000 ₽ / 4 tenants = 7 500 ₽ raw infra / tenant / month
```
